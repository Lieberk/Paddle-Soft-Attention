...
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
      ...
      # input json
    parser.add_argument('--input_json', default='D:/dataset/caption_datasets/dataset_flickr8k.json', help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='D:/dataset/f8k_data_vgg/f8ktalk.json', help='output json file')
    parser.add_argument('--output_h5', default='D:/dataset/f8k_data_vgg/f8ktalk', help='output h5 file')
